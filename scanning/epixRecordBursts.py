...
if __name__ == "__main__":
    ...
    parser.add_option("-D","--detector",dest="detector",type="int",default=0x005300,
    ...
    parser.add_option("-t","--typeID",dest="typeID",type="int",default=0x1004b,
	...
	if options.steps > cycle + 1 and options.gap != 0 :
	    ...
	    if options.exclude == 'None' :
	        time.sleep(options.gap)
                ...
                daq.configure(events=options.events,controls=[],partition=partition)
